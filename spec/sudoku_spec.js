...
(function() {
  var Sudoku, solvedString, unsolvedString, _;

  _ = require('underscore')._;

  Sudoku = require('../sudoku');

  unsolvedString = '619030040270061008000047621486302079000014580031009060005720806320106057160400030';

  solvedString = '619238745274561398853947621486352179792614583531879264945723816328196457167485932';
  ...
  describe('a new Sudoku game', function() {
    ...
    return it('can get an entries box index', function() {
      var sudoku;
      sudoku = new Sudoku('0');
